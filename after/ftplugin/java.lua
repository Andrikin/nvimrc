...
local jdtls_path = '/home/andre/.config/nvim/servers/jdtls'
...
local config = {
  cmd = {
    ...
    "-data", vim.fn.expand(vim.env.HOME .. '/.cache/jdtls-workspace/') .. workspace_dir
  },
  settings = {
    ['java.format.settings.url'] = vim.fn.expand(vim.env.HOME .. "/.jdtls/formatter.xml")
  },
