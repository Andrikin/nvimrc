...
" TODO: Manage $VIM, treesitter for vim?
...
let s:OPTSFILE = fnamemodify($MYVIMRC, ':h') .. '/optfiles'
 ...
 " Dirvish XDGlikesh
 command! Downloads execute 'Dirvish ' .. $HOMEDRIVE .. $HOMEPATH .. '/Downloads'
 command! Documents execute 'Dirvish ' .. $HOMEDRIVE .. $HOMEPATH .. '/Documents'
 command! Desktop execute 'Dirvish ' .. $HOMEDRIVE .. $HOMEPATH .. '/Desktop'
